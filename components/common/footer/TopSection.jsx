      ...
      <div className="pt-48 px-[5rem]">
        <div className="h-[17.875rem] flex justify-between">
          ...
          <div className="text-white space-y-8">
            <div className="font-bold text-xl leading-[1.875rem]">Pages</div> {/* pages */}
            <div className="space-y-4">
              <div className="font-normal text-base leading-6">Home</div>
              <div className="font-normal text-base leading-6">Podcast</div>
              <div className="font-normal text-base leading-6">Host</div>
              <div className="font-normal text-base leading-6">Blog</div>
            </div>
          </div>
          <div className="text-white space-y-8">
            <div className="font-bold text-xl leading-[1.875rem]">Reach Us</div> {/* reach us */}
            <div className="space-y-4">
              <div className="font-normal text-base leading-6">Contact</div>
              <div className="font-normal text-base leading-6">About</div>
            </div>
          </div>
          <div className="text-white space-y-8">
            <div className="font-bold text-xl leading-[1.875rem]">  {/* subscribe */}
              Subscribe
            </div>
